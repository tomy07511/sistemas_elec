...
app.post('/upload', (req, res) => {
  ...
  readXlsxFile(excelFile.data)
    .then((rows) => {
      ...
      req.flash('success_msg', 'Archivo Excel procesado con éxito.');
      // Agrega excelData al objeto al renderizar la vista
      res.render('ruta_de_redireccion', { success_msg: 'Archivo Excel procesado con éxito.', excelData: rows });
    })
    .catch((error) => {
